...
@Component({
  ...
  <div class="alert alert-danger" *ngIf="enlistaerror">
    ...
    <tienda-addproductos *ngIf="cargoConfig && ptipomant=='A'" 
    vparcaptura="{{pvaparam}}"></tienda-addproductos>
    <tienda-editproductos *ngIf="cargoConfig && ptipomant=='E'" 
        vparcaptura="{{pvaparam}}" 
        vid="{{pid}}" >
     </tienda-editproductos>
     <tienda-verproductos *ngIf="cargoConfig && ptipomant=='C'"  
         vparcaptura="{{pvaparam}}" 
         vid="{{pid}}" >
    </tienda-verproductos>
    </kendo-dialog>
...
export class Netsproductosmodal implements OnInit {
