...
import {AddregCategoriaComponent} from'../adicionar/adicionar.component';

@Component({
  selector: 'tienda-editcategoria',
  templateUrl: './editar.component.html',
  styleUrls: ['./editar.component.css']
})
export class EditregCategoriaComponent implements OnInit {
  ...
  public liscampvcategor = [
    ...
    { titulo: 'Cod_Categoria', campo: 'cod_categor' }
