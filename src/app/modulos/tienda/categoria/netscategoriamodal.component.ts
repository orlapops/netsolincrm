...
@Component({
  ...
  <div class="alert alert-danger" *ngIf="enlistaerror">
    ...
    <tienda-addcategoria *ngIf="cargoConfig && ptipomant=='A'" 
    vparcaptura="{{pvaparam}}"></tienda-addcategoria>
    <tienda-editcategoria *ngIf="cargoConfig && ptipomant=='E'" 
        vparcaptura="{{pvaparam}}" 
        vid="{{pid}}" >
     </tienda-editcategoria>
     <tienda-vercategoria *ngIf="cargoConfig && ptipomant=='C'"  
         vparcaptura="{{pvaparam}}" 
         vid="{{pid}}" >
    </tienda-vercategoria>
    </kendo-dialog>
...
export class Netscategoriamodal implements OnInit {
