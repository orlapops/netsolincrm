...
@Component({
  ...
  <div class="alert alert-danger" *ngIf="enlistaerror">
    ...
    <tienda-addsubcatego *ngIf="cargoConfig && ptipomant=='A'" 
    vparcaptura="{{pvaparam}}"></tienda-addsubcatego>
    <tienda-editsubcatego *ngIf="cargoConfig && ptipomant=='E'" 
        vparcaptura="{{pvaparam}}" 
        vid="{{pid}}" >
     </tienda-editsubcatego>
     <tienda-versubcatego *ngIf="cargoConfig && ptipomant=='C'"  
         vparcaptura="{{pvaparam}}" 
         vid="{{pid}}" >
    </tienda-versubcatego>
    </kendo-dialog>
...
export class Netssubcategomodal implements OnInit {
