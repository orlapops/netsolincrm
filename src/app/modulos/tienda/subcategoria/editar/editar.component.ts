...
import {AddregSubcategoComponent} from'../../subcategoria/adicionar/adicionar.component';

@Component({
  selector: 'tienda-editsubcatego',
  templateUrl: './editar.component.html',
  styleUrls: ['./editar.component.css']
})
export class EditregSubcategoComponent implements OnInit {
  ...
  public liscampvcategor = [
    ...
    { titulo: 'Id_Categoria', campo: 'id_categoria' },
    ...
    { titulo: 'Cod Subcategoria', campo: 'cod_subcatg' }
