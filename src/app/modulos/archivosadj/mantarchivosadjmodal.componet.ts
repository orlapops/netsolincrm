...
@Component({
    ...
    template: `
        <kendo-dialog title="{{ptitulo}}" 
          ...
          <add-archivosadj *ngIf="cargoConfig && ptipomant=='A'" 
          vparcaptura="{{pvaparam}}" modulo_asoc="{{modulo_asoc}}" id_modasoc="{{id_modasoc}}" (pasarDatos)="refrescaTotalesdeta($event)"></add-archivosadj>
          <edit-archivosadj *ngIf="cargoConfig && ptipomant=='E'" 
              vparcaptura="{{pvaparam}}" 
              vid="{{pid}}" modulo_asoc="{{modulo_asoc}}" id_modasoc="{{id_modasoc}}"  (pasarDatos)="refrescaTotalesdeta($event)">
           </edit-archivosadj>
           <ver-archivosadj *ngIf="cargoConfig && ptipomant=='C'"  
               vparcaptura="{{pvaparam}}" 
               vid="{{pid}}" modulo_asoc="{{modulo_asoc}}" id_modasoc="{{id_modasoc}}"  (pasarDatos)="refrescaTotalesdeta($event)">
          </ver-archivosadj>         
            </kendo-dialog>
...
export class Netsmantarchivosadjmmodal implements OnInit {
