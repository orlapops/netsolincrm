...
@Component({
    ...
    template: `
        <kendo-dialog title="{{ptitulo}}" 
          ...
          <crm-addcotiza *ngIf="cargoConfig && ptipomant=='A'" 
          vparcaptura="{{pvaparam}}" idccotiza="{{idccotiza}}" (pasarDatos)="refrescaTotalesdeta($event)"></crm-addcotiza>
          <crm-editdcotiza *ngIf="cargoConfig && ptipomant=='E'" 
              vparcaptura="{{pvaparam}}" 
              vid="{{pid}}" idccotiza="{{idccotiza}}">
           </crm-editdcotiza>
           <crm-verdcotiza *ngIf="cargoConfig && ptipomant=='C'"  
               vparcaptura="{{pvaparam}}" 
               vid="{{pid}}" idccotiza="{{idccotiza}}">
          </crm-verdcotiza>         
            </kendo-dialog>
...
export class Netsmantcotizadprodcrmmodal implements OnInit {
