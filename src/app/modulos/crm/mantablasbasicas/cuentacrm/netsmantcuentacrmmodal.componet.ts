    ...
    template: `
        <kendo-dialog title="{{ptitulo}}" 
          ...
          <div class="alert alert-danger" *ngIf="enlistaerror">
            ...
            <crm-addcuenta *ngIf="cargoConfig && ptipomant=='A'" 
            vparcaptura="{{pvaparam}}"></crm-addcuenta>
            <crm-editcuenta *ngIf="cargoConfig && ptipomant=='E'" 
                vparcaptura="{{pvaparam}}" 
                vid="{{pid}}" >
             </crm-editcuenta>
             <crm-vertcuenta *ngIf="cargoConfig && ptipomant=='C'"  
                 vparcaptura="{{pvaparam}}" 
                 vid="{{pid}}" >
            </crm-vertcuenta>
            </kendo-dialog>
...
export class Netsmantcuentacrmmodal implements OnInit {
