    ...
    template: `
        <kendo-dialog title="{{ptitulo}}" 
          ...
          <div class="alert alert-danger" *ngIf="enlistaerror">
            ...
            <crm-addfichatec *ngIf="cargoConfig && ptipomant=='A'" 
            vparcaptura="{{pvaparam}}"></crm-addfichatec>
            <crm-editfichatec *ngIf="cargoConfig && ptipomant=='E'" 
                vparcaptura="{{pvaparam}}" 
                vid="{{pid}}" >
             </crm-editfichatec>
             <crm-vertfichatec *ngIf="cargoConfig && ptipomant=='C'"  
                 vparcaptura="{{pvaparam}}" 
                 vtipoficha="{{ptipoficha}}"
                 vid="{{pid}}" >
            </crm-vertfichatec>
            </kendo-dialog>
  `
})
export class NetsmantFichateccrmmodal implements OnInit {
    @Input() ptitulo: string;
    @Input() pvaparam: string;
    @Input() pobjeto: string;
    @Input() ptipomant: string;
    @Input() ptipoficha: string;
    @Input() pid: any;
    ...
    ngOnInit() {
        ...
        console.log('contro ficha tec ptipoficha');
        console.log(this.ptipoficha);
