    ...
    template: `
        <kendo-dialog title="{{ptitulo}}" 
          ...
          <div class="alert alert-danger" *ngIf="enlistaerror">
            ...
            <crm-addcontacto *ngIf="cargoConfig && ptipomant=='A'" 
            vparcaptura="{{pvaparam}}"></crm-addcontacto>
            <crm-editcontacto *ngIf="cargoConfig && ptipomant=='E'" 
                vparcaptura="{{pvaparam}}" 
                vid="{{pid}}" >
             </crm-editcontacto>
             <crm-vertcontacto *ngIf="cargoConfig && ptipomant=='C'"  
                 vparcaptura="{{pvaparam}}" 
                 vid="{{pid}}" >
            </crm-vertcontacto>
            </kendo-dialog>
...
export class Netsmantcontactocrmmodal implements OnInit {
