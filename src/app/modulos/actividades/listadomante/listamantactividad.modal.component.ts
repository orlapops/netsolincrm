...
@Component({
    selector: 'app-listmantactividad',
    encapsulation: ViewEncapsulation.None,
    templateUrl: './listamantactividad.modal.component.html',
    styleUrls: ['./listamantactividad.modal.component.css']
})
export class ListmantactividadmodalComponent implements OnInit {
  ...
  @Input() id_modasoc: number;
    ...
    ngOnInit() {
        // console.log("ngOnInit listar.actividad");
        // console.log('this.id_cuentacrm:'+this.id_cuentacrm);
        // console.log('this.id_modasoc:'+this.id_modasoc);
